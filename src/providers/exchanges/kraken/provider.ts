import { kraken, type Order as CcxtOrder } from 'ccxt';
...
export class KrakenProvider extends Provider {
  readonly name = 'kraken';

  private exchange: kraken | null = null;
  ...
  private ex(): kraken {
    if (!this.exchange) throw new Error('KrakenProvider: call connect() first');
