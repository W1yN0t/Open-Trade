import { bybit, type Order as CcxtOrder } from 'ccxt';
...
export class BybitProvider extends Provider {
  readonly name = 'bybit';

  private exchange: bybit | null = null;
  ...
  private ex(): bybit {
    if (!this.exchange) throw new Error('BybitProvider: call connect() first');
